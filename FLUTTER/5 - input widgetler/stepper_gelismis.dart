...
class GelismisStepperOrnek extends StatefulWidget {
  @override
  _GelismisStepperOrnekState createState() => _GelismisStepperOrnekState();
}

class _GelismisStepperOrnekState extends State<GelismisStepperOrnek> {
  int _aktifStep = 0;
  String isim = '', mail = '', sifre = '';
  List<Step> tumStepler = [];
  bool hata = false;

  //validatoru ayrı ayrı kullanmak için key oluşturduk
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Stepper(
          ...
          steps: tumStepler,
          /* //kullanıcı istediği stepe tıklayamasın diye kapattık
  ...
  //stateleri tek alana bağladık tek tek uğraşmamak için
  ...
  void _ileriButonuKontrolu() {
    switch (_aktifStep) {
      case 0:
        //eger key'in o anki degeri dogrulanmışsa
